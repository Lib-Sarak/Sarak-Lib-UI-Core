---
name: Sarak-UI-Import
description: Instalação e acoplamento plug-and-play da biblioteca Sarak-Lib-UI-Core em sistemas consumidores (Node.js e Python).
---
