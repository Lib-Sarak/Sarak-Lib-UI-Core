...
export class MemoryVectorStore implements VectorStoreInterface {
    private embeddings: EmbeddingsInterface;
    private storage: Record<string, Record<string, any[]>>;

    constructor(embeddingsProvider: EmbeddingsInterface = new MemoryEmbeddings()) {
    ...
    async addDocuments(
        ...
        if (!this.storage[tableName][agentId]) this.storage[tableName][agentId] = [];
