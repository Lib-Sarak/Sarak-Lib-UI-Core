...
- **Versão da lib:** `2.1.0`
- **Carimbo do kit (`kitHash`):** `542bbea5b2fb` — igual ao do arquivo `VERSION`.
- **Superfície desta versão:** 87 componentes públicos · 422 tokens de tema · 73 CSS Variables · 100 ícones · 18 temas embutidos.
