...
- **Versão da lib:** `1.2.0`
- **Carimbo do kit (`kitHash`):** `36b5cb181288` — igual ao do arquivo `VERSION`.
- **Superfície desta versão:** 87 componentes públicos · 304 tokens de tema · 97 CSS Variables · 100 ícones · 18 temas embutidos.
