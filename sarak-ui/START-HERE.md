...
- **Versão da lib:** `6.3.0`
- **Carimbo do kit (`kitHash`):** `320b9835b798` — igual ao do arquivo `VERSION`.
- **Superfície desta versão:** 88 componentes públicos · 428 tokens de tema · 73 CSS Variables · 100 ícones · 23 temas embutidos.
