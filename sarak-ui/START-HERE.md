...
- **Versão da lib:** `6.1.0`
- **Carimbo do kit (`kitHash`):** `837e85728881` — igual ao do arquivo `VERSION`.
- **Superfície desta versão:** 83 componentes públicos · 423 tokens de tema · 73 CSS Variables · 100 ícones · 23 temas embutidos.
