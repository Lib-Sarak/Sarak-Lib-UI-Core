...
- **Versão da lib:** `6.3.0`
- **Carimbo do kit (`kitHash`):** `6a040a35c081` — igual ao do arquivo `VERSION`.
- **Superfície desta versão:** 90 componentes públicos · 427 tokens de tema · 73 CSS Variables · 100 ícones · 14 temas embutidos.
