...
- **Versão da lib:** `6.3.0`
- **Carimbo do kit (`kitHash`):** `2ada387f72d6` — igual ao do arquivo `VERSION`.
- **Superfície desta versão:** 88 componentes públicos · 427 tokens de tema · 73 CSS Variables · 100 ícones · 23 temas embutidos.
