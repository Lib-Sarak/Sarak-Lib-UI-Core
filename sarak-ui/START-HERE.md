...
- **Versão da lib:** `2.0.0`
- **Carimbo do kit (`kitHash`):** `17a213e37900` — igual ao do arquivo `VERSION`.
- **Superfície desta versão:** 86 componentes públicos · 422 tokens de tema · 97 CSS Variables · 100 ícones · 18 temas embutidos.
