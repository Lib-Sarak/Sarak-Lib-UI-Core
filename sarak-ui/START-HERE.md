...
- **Versão da lib:** `6.3.0`
- **Carimbo do kit (`kitHash`):** `7d7f3a09a39a` — igual ao do arquivo `VERSION`.
- **Superfície desta versão:** 88 componentes públicos · 427 tokens de tema · 73 CSS Variables · 100 ícones · 11 temas embutidos.
