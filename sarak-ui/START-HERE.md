...
- **Versão da lib:** `1.1.0`
- **Carimbo do kit (`kitHash`):** `9d9d0ad7d113` — igual ao do arquivo `VERSION`.
- **Superfície desta versão:** 85 componentes públicos · 304 tokens de tema · 97 CSS Variables · 100 ícones · 18 temas embutidos.
