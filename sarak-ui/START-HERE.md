...
- **Versão da lib:** `1.2.1`
- **Carimbo do kit (`kitHash`):** `6c3f296302d7` — igual ao do arquivo `VERSION`.
- **Superfície desta versão:** 86 componentes públicos · 304 tokens de tema · 97 CSS Variables · 100 ícones · 18 temas embutidos.
