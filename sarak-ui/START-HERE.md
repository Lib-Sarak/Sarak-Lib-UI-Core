...
- **Versão da lib:** `2.0.0`
- **Carimbo do kit (`kitHash`):** `eb3fcac8769b` — igual ao do arquivo `VERSION`.
- **Superfície desta versão:** 86 componentes públicos · 409 tokens de tema · 97 CSS Variables · 100 ícones · 18 temas embutidos.
