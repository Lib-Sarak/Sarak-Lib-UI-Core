...
- **Versão da lib:** `6.3.0`
- **Carimbo do kit (`kitHash`):** `b63067927f73` — igual ao do arquivo `VERSION`.
- **Superfície desta versão:** 88 componentes públicos · 423 tokens de tema · 73 CSS Variables · 100 ícones · 23 temas embutidos.
