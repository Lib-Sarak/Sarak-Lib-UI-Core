...
- **Versão da lib:** `6.1.0` · **carimbo do estado:** `af94c63af80b`
...
- **Gates:** 23 registrados · 12 auditores em `run_audit.mjs`
- **Base de specs:** 11 ADRs · 6 documentos de arquitetura · 18 specs
