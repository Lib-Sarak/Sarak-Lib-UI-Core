...
- **Versão da lib:** `1.1.0` · **carimbo do estado:** `c7b2e2c82ccb`
...
- **Gates:** 9 registrados · 8 auditores em `run_audit.mjs`
- **Base de specs:** 8 ADRs · 17 documentos de arquitetura · 27 specs
- **Baseline dos auditores medido em:** 2026-07-28
