...
| 19 | [plan-43-artefatos-de-persistencia-de-tema](plan/plan-43-artefatos-de-persistencia-de-tema.md) | O importador que decidir persistir tema recebe da lib o formato do dado, um schema de referência em dois dialetos e o exemplo de ligação — em vez de ter que engenharia-reversa a partir dos tipos | plan-42 | 🔴 A executar | specs/specs/13-instalacao-e-atualizacao.md · specs/specs/09-temas-e-presets.md |
