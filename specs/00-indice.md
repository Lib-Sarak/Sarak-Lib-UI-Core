...
|---|---|---|---|---|---|
| 1 | [plan-61-fundo-de-midia-no-cromo-do-modo-ui-kit](plan/plan-61-fundo-de-midia-no-cromo-do-modo-ui-kit.md) | Escolher uma mídia de fundo passa a mudar a tela também no SarakAppChrome, e não só no SarakShell | — | 🟢 Aprovada | specs/05-cromo-e-slots.md |
| 2 | [plan-62-fronteira-de-validacao-aceita-midia-embutida](plan/plan-62-fronteira-de-validacao-aceita-midia-embutida.md) | Uma imagem enviada pelo painel deixa de ser descartada em silêncio ao chegar no design do sistema | — | 🟢 Aprovada | specs/10-seguranca-e-acessibilidade.md |
| 3 | [plan-63-aplicar-tema-do-catalogo-volta-a-ser-rascunho](plan/plan-63-aplicar-tema-do-catalogo-volta-a-ser-rascunho.md) | Escolher um tema no catálogo previsualiza sem alterar nem persistir o sistema, que só muda por confirmação explícita | — | 🟢 Aprovada | specs/06-painel-de-customizacao-e-preview.md |
...
| 5 | [plan-65-publicar-os-widgets-do-cromo](plan/plan-65-publicar-os-widgets-do-cromo.md) | Busca, alternância de tema, usuário e idioma passam a ser alcançáveis pelo consumidor, para que os slots do cromo tenham com o que ser preenchidos | — | 🟢 Aprovada | arquitetura/03-superficie-publica.md |
