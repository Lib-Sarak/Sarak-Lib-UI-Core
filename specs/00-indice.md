...
| 3 | [plan-18-atomo-sem-provider](plan/plan-18-atomo-sem-provider.md) | Fazer o átomo Sarak renderizar sem `SarakUIProvider` — destrava 20 das 23 de R10 | plan-15 | 🟡 Em execução | `specs/arquitetura/03-superficie-publica.md` · `specs/00-regras-e-invariantes.md` |
