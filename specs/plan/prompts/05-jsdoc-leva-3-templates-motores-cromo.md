# Prompt direto 05 — documentar as props, leva 3 (templates, motores e cromo)
...
> `FilterSelect`, `SocialButton` e os quatro `Shell*` mudaram — use os nomes novos.
...
**Componentes desta leva:** `SarakChart`, `SarakChartEngine`, `SarakChat`,
`SarakChatEngine`, `SarakFlowEngine`, `SarakCatalogGrid`, `SarakManagementGrid`,
`SarakStats`, `FilterSelect`, `SocialButton`, `ShellSearchWidget`,
`ShellThemeToggle`, `ShellUserWidget`, `ShellLanguageSelector`.
