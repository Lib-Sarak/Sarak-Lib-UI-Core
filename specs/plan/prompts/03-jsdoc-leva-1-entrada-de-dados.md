# Prompt direto 03 — documentar as props, leva 1 (entrada de dados)
...
> Medição de origem: das 469 props públicas, 180 tinham documentação (38%), e 31 componentes não tinham
> nenhuma. Reconte com `docs/component-catalog.json` antes de usar este bloco.
