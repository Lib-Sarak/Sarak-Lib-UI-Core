...
status: "🟡 Em Andamento (Sub-bloco 1 de Hooks e Paineis concluído, restam ~137)"
prioridade: "Média"
...
- ~~`Panels/LayoutTab.tsx` — 1~~ · ~~`Panels/ShortcutsTab.tsx` — 1~~ · ~~`Panels/components/PillarSelector.tsx` — 1~~ · demais `*Tab.tsx`, `*Catalog.tsx`, `*Control(s).tsx` — 1–2 cada (cauda longa)
