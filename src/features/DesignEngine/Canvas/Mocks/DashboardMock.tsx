...
export const MockDashboard: React.FC<MockDashboardProps> = ({ tokens }) => {
  ...
  const items = {
    ...
    anomaly: { title: "Anomaly Radar", subtitle: "Sector D-12", description: "Unusual thermal variation detected.", price_in: "0.0015", price_out: "0.0020" }
  };
  ...
  const mappings = {
    ...
    anomaly: { title: "title", subtitle: "subtitle", description: "description", icon: "AlertTriangle" }
  };
