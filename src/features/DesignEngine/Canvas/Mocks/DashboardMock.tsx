...
export const MockDashboard: React.FC<MockDashboardProps> = ({ tokens }) => {
  ...
  const sidePanelNode = (
    <SmartCard className="h-[420px] lg:h-full w-full !p-5 @md:!p-6" label="Card de Texto (Logs)">
  ...
  const mainContentNode = (
    <div className="w-full min-h-full bg-transparent font-sans text-slate-200">
      ...
      <div className="grid grid-cols-1 @md:grid-cols-12 gap-6 auto-rows-auto">
        ...
        <SmartCard className="@md:col-span-12 h-[420px] p-5 @md:p-6 @lg:p-8" label="Card de Gráficos (Data Flow)">
