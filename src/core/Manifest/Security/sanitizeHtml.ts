 ...
 *
 * ÚNICO ponto autorizado a transformar HTML/Markdown não confiável em HTML seguro no
 * bloco funcional. Toda renderização rica (o futuro `SarakMarkdownRenderer` da Spec 15)
 * DEVE passar por aqui; é PROIBIDO usar `dangerouslySetInnerHTML` com conteúdo de
