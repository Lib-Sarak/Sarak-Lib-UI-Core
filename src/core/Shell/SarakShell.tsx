...
export const SarakShell: React.FC<SarakShellProps> = (props) => {
    ...
    return (
        <div className={`@container ${shellClass} ${isMobile ? '!flex-col' : ''} ${design.globalBackgroundImageUrl ? 'bg-transparent' : 'bg-[var(--theme-body)]'} text-[var(--color-theme-title,#ffffff)] font-sans selection:bg-[var(--theme-primary)] selection:text-[var(--theme-on-primary)] ${layoutClass}`}>
