...
export const ShellSchema: ComponentSchema = {
    ...
    tokens: [
        // --- ESTRUTURA MASTER ---
        {
            ...
            constraints: {
                options: [
                    { id: 'sidebar', label: 'Sidebar Vertical (Fixo Esquerda)' },
                    { id: 'topbar', label: 'Topbar Horizontal (Fixo Superior)' },
                    { id: 'dock', label: 'Doca Flutuante (Dock)' },
                    { id: 'glass', label: 'Glass (Soberano / Transparente)' }
                ]
            },
            defaultValue: 'sidebar',
            cssVars: ['--sarak-nav-style', '--sarak-layout-type']
        },
