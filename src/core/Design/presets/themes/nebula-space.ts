...
export const nebulaSpaceTheme: ThemePreset = {
    ...
    contraparte: {
        ...
        sidebarHoverColor: 'rgba(255, 0, 127, 0.06)',
        topbarColor: 'rgba(255, 255, 255, 0.7)',
        topbarHoverColor: 'rgba(255, 0, 127, 0.06)',
        topbarTitleColor: '#7a0048',
        cardBackgroundColor: 'rgba(255, 255, 255, 0.7)',
        cardBorderColor: 'rgba(122, 0, 72, 0.2)',
        cardHeaderBg: '#f3eaf1',
        cardHeaderBorder: '#e6d4e2',
        cardFooterBg: 'transparent',
        cardFooterBorder: '#e6d4e2',
        cardTitleColor: '#7a0048',
        cardTitleIconGlow: 'rgba(122, 0, 72, 0.2)',
        cardActionBtnPrimaryBg: '#a8005f',
        cardActionBtnHoverBg: '#8a004d',
        cardActionBtnText: '#ffffff',
        cardSearchBgFocus: '#f3eaf1',
        cardSearchPlaceholderColor: '#6b5866',
        cardSearchTextFocusColor: '#2b0d1e',
        modalOverlayColor: 'rgba(255, 255, 255, 0.85)',
        tooltipBg: '#2b0d1e',
        tooltipTextColor: '#ffffff',
        tableHeaderBg: '#f3eaf1',
        tableRowHoverBg: '#efe0ec',
        tableBorderColor: '#e6d4e2',
        textColorMaster: '#2b0d1e',
        textColorSecondary: '#5a3a4c',
        textColorMuted: '#6b5866',
        btnSecondaryBg: '#efe0ec',
        btnGhostHoverBg: '#f3eaf1',
        inputBg: '#ffffff',
        inputBorderColor: '#e6d4e2',
        inputTextColor: '#2b0d1e',
        surfaceColor: '#f3eaf1',
        titleColor: '#2b0d1e',
        colorBgBody: '#f8f7fb',
        colorBgLayer1: '#ffffff',
        colorBgLayer2: '#f2eaf0',
        colorBgModal: '#f8f7fb',
        chartTooltipBg: '#f3eaf1',
        scrollThumbColor: '#7a0048',
        aiPanelBg: 'rgba(255, 255, 255, 0.7)',
        matrixItemBg: '#f3eaf1',
        matrixBorderColor: '#e6d4e2',
        matrixSearchBg: '#ffffff',
        navItemActiveColor: '#7a0048',
    }
};
