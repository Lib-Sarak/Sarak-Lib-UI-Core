...
export const naturebreezeTheme: ThemePreset = {
    id: 'nature-breeze',
    name: 'Nature Breeze',
    description: 'Organic, lots of glass, sparse shadows, massive rounded corners.',
    design: {
        ...
        textColorMaster: '#d2f2d5',
        textColorSecondary: '#ffffffdb',
        textColorMuted: '#ffffffdb',
        h1Size: 48,
        h1Weight: "900",
        h1LineHeight: 1.1,
        h1LetterSpacing: -1,
        ...
        matrixBlur: 10,
        cardShadow: "0 30px 60px -10px rgba(46, 125, 50, 0.15)"
}
};
