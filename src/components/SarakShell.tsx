...
/**
 * Smart SarakShell — Renderiza automaticamente as abas dos módulos registrados.
 * Não requer configuração de navegação manual no microsserviço.
 */
        ...
        <div className=\"sarak-shell min-h-screen bg-[#0a0a0b] text-white font-sans selection:bg-blue-500/30 overflow-hidden flex flex-col\">
            ...
            <div className=\"flex flex-1 overflow-hidden\">
                ...
                <aside className=\"w-64 border-r border-white/5 bg-[#0f0f11] flex flex-col p-4 gap-2\">
                    <div className=\"text-[10px] font-bold text-white/30 uppercase tracking-[0.2em] mb-4 px-2\">Módulos Ativos</div>
                    {modules.map(mod => (
                        <button
                            key={mod.id}
