...
export const SocialButton: React.FC<SocialButtonProps> = ({
    ...
    const icons: Record<'google' | 'github', React.ReactNode> = {
        google: (
            // Cores oficiais da marca Google (G-logo, 4 cores): fixas por guideline de marca,
            // nunca tematizáveis — por isso não mapeiam para uma custom property do Design System.
            <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                {/* sarak-allow-hardcode: cor oficial da marca Google (G-logo) — guideline fixa, não é tema. */}
