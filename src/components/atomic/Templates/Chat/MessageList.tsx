  ...
  >
    {messages.length === 0 && (
      <div className="flex flex-col items-center justify-center h-full text-center space-y-4 animate-in fade-in zoom-in duration-700">
        ...
        <h3 className="text-lg font-medium text-[var(--theme-title)]">Interface de Sistema Inicializada</h3>
        <p className="text-sm text-[var(--theme-muted)] max-w-sm">
    ...
    {isLoading && (
      <div className="flex justify-start">
        <div className="bg-[var(--theme-muted)]/10 border border-[var(--theme-border)] p-4 rounded-2xl rounded-tl-none shadow-sm">
          ...
          {isProcessingFiles && <p className="text-3xs mt-2 font-mono text-[var(--theme-muted)] uppercase tracking-widest animate-pulse">Codificando Imagens...</p>}
        </div>
      </div>
    )}
  </div>
